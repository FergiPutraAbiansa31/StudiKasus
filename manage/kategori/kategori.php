                                                            ...
                                                            <form action="edit.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="kategori" class="form-control" id="kategori" value="<?= $row['kategori'] ?>" required>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="hapus.php" method="POST" enctype="multipart/form-data">
                                                                <input type="hidden" name="id_kategori" value="<?= $row['id_kategori'] ?>">
                                                                <div class="modal-body">
                                                                    <h5 class="text-center"> Apakah Anda Yakin Akan Hapus Kategori <br>
                                                                        <span class="text-danger"><?= $row['kategori'] ?></span>
                                                                    </h5>
                                                                </div>
                                                                <div class="modal-footer">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="tambah.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label" for="ukuran">Kategori</label>
