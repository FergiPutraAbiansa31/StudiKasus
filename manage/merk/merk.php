...
<body>
                                                    ...
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title">Edit Data Merk</h5>
                                                            ...
                                                            <form action="edit.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" name="nama_merk" class="form-control" id="nama_merk" value="<?= $row['nama_merk'] ?>" required>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <form action="hapus.php" method="POST" enctype="multipart/form-data">
                                                                ...
                                                                <div class="modal-body">
                                                                    <h5 class="text-center"> Apakah Anda Yakin Akan Hapus <br>
                                                                        <span class="text-danger"><?= $row['nama_merk'] ?></span>
                                                                    </h5>
                                                                </div>
                                                                <div class="modal-footer">
    ...
    <div id="tambah" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Merk</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form action="tambah.php" method="POST" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label" for="nama_merk">Nama Merk</label>
                            <input type="text" name="nama_merk" class="form-control" id="nama_merk" required>
                        </div>
                        <div class="modal-footer">
                            <button type="reset" class="btn btn-danger">Reset</button>
                            <input type="submit" class="btn btn-success" name="tambah" value="simpan"></button>
