<?php
include 'koneksi.php';
$alls = mysqli_query($conn, "SELECT id_sepatu, img, nama_sepatu, harga, stok FROM sepatu");
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <button class="btn btn-success active" onclick="location.href='shop.php';">Semua</button>
                            </li>
                            <li class="list-inline-item">
                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                <div class="card rounded-0">
                                    <img class="card-img rounded-0 img-fluid" src="image/<?= $all['img']; ?>" width="300" height="360">
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                        <ul class="list-unstyled">
                                            <li><a class="btn btn-success text-white mt-2" href="detail.php?id=<?= $all['id_sepatu']; ?>"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-unstyled d-flex justify-content-between">
                                        <li class="text text-left">Rp <?= number_format($all['harga'], 0, ',', '.'); ?></li>
                                    </ul>
                                    <a href="detail.php?id=<?= $all['id_sepatu']; ?>" class="h2 text-decoration-none text-dark"><?= $all['nama_sepatu']; ?></a>
                                    <p>Stok (<?= $all['stok']; ?>)</p>
                                </div>
                            </div>
                        </div>
