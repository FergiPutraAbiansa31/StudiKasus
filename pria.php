<?php
include 'koneksi.php';
$prias= mysqli_query($conn, "SELECT id_sepatu, img, nama_sepatu, harga, stok 
    FROM sepatu
    JOIN kategori ON sepatu.id_kategori = kategori.id_kategori 
    WHERE kategori.kategori = 'Sepatu Pria'");
?>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-12">
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            ...
                            <li class="list-inline-item">
                                <button class="btn btn-success" onclick="location.href='pria.php';">Pria</button>
                            </li>
                            <li class="list-inline-item">
                ...
                <div class="row">
                    <?php foreach ($prias as $pria) : ?>
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                <div class="card rounded-0">
                                    <img class="card-img rounded-0 img-fluid" src="image/<?= $pria['img']; ?>" width="300" height="360">
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                        <ul class="list-unstyled">
                                            <li><a class="btn btn-success text-white mt-2" href="detail.php?id=<?= $pria['id_sepatu']; ?>"><i class="far fa-eye"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                                <div class="card-body">
                                    <ul class="list-unstyled d-flex justify-content-between">
                                        <li class="text text-left">Rp <?= number_format($pria['harga'], 0, ',', '.'); ?></li>
                                    </ul>
                                    <a href="detail.php?id=<?= $pria['id_sepatu']; ?>" class="h2 text-decoration-none text-dark"><?= $pria['nama_sepatu']; ?></a>
                                    <p>Stok (<?= $pria['stok']; ?>)</p>
                                </div>
                            </div>
                        </div>
